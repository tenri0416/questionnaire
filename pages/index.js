    ...
    <>
      <Container>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          {
            watchIs === "true" || watchWas === "true" ?
              < div >
                <span>今まで学習したことあるプログラミング言語を全て教えて下さい。</span>

                <textarea id="lang"{...register('lang')} />
              </div> : null
          }
...
//errors.name属性でエラーメッセージ
//registerで入力されたデータが簡単に取得できる
//required:trueでこの値は入力必須ですよを実装
//pattenは正規表示を指定できる
